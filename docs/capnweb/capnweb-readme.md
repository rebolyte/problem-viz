...
- Workers RPC supports sending values that contain aliases and cycles. This can actually cause problems, so we actually plan to _remove_ this feature from Workers RPC (with a compatibility flag, of course).
